async function search(query, page, { fetch }) {
...
async function fetchAnimeInfo(url, { fetch }) {
...
async function fetchEpisodes(url, { fetch }) {
  return [];
}

async function loadEpisodeSources(url, { fetch }) {
  return [];
}
